...
namespace Interface
{
    public partial class FrmEmployees : Form
    {
        ...
        {
            FrmSaveEmployee frmSaveUser = new FrmSaveEmployee();
        ...
        private void LoadEmployees()
        {
            try
            {
                ...
                DataTable dtUsers = string.IsNullOrWhiteSpace(txtName.Text) ? Employee.FindAll(pageSelected, quantRows) : Employee.FindByName(txtName.Text.Trim(), pageSelected, quantRows);
        ...
        private void dgvUsers_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (dgvUsers.CurrentCell.ColumnIndex == 1)
            {
                ...
                FrmSaveEmployee frmUser = new FrmSaveEmployee(id, name, CPF, phone, address);
                frmUser.ShowDialog();
                if (frmUser.isSaved)
                    isConfirmed = true;
            }
